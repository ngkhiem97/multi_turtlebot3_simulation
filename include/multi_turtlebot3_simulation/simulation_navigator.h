#ifndef MULTI_TURTLEBOT3_SIMULATION_SIMULATION_NAVIGATOR
#define MULTI_TURTLEBOT3_SIMULATION_SIMULATION_NAVIGATOR
...
{ 
    public: 
      SimulationNavigator(const std::string s_robot_namespace, 
